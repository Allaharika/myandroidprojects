...
public class MainActivity extends AppCompatActivity {
    ...
    public void Login(View view) {
        ...
        if(email.isEmpty()|password.isEmpty()){
            Toast.makeText(this,"Find all the details",Toast.LENGTH_SHORT).show();
        }
        else{
    ...
    public void reset(View view) {
        ...
        View v= LayoutInflater.from(this).inflate(R.layout.resetfile,null,false);
        EditText email=findViewById(R.id.editEmailAdress);
        b.setView(v);
